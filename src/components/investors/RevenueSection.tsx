...
const RevenueSection = () => {
  return (
    <div className="w-full py-20" style={{
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 bg-white/30 backdrop-blur-sm rounded-lg p-8 shadow-lg">
        ...
        <div className="overflow-hidden mx-auto" style={{ maxWidth: "700px", height: "350px" }}>
