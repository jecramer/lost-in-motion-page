      ...
      <DialogContent className="max-w-4xl p-0 overflow-hidden">
        ...
        <div className="flex flex-col">
          <div className="relative">
            <img src="/lovable-uploads/19d8307a-d2fb-4bfe-a96d-a82ac1e31332.png" alt={personName} className="w-[892px] full h-[500px] object-fill" />
          ...
          <div className="p-6 bg-[#94af45]">
            <h4 className="text-xl font-semibold mb-4">Katty's Top 10 Favourite Books</h4>
            <ScrollArea className="w-full" style={{
            overflow: 'auto'
          }}>
              <div className="flex gap-4 pb-4 w-max">
                {bookRecommendations.map((book, index) => <div key={index} className="flex-shrink-0">
                    <div className="w-32 h-48 bg-gray-100 rounded overflow-hidden mb-2">
                      {bookCovers[index].data ? <img src={bookCovers[index].data} alt={`${book.title} cover`} className="w-full h-full object-cover" /> : <div className="w-full h-full bg-gray-200 animate-pulse" />}
                    </div>
                    <div className="w-32">
