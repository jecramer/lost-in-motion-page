    ...
    backgroundAttachment: 'fixed'
      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="font-newsreader font-semibold text-5xl mb-10 text-slate-950">Product & Company Roadmap</h2>
          <p className="mb-8 opacity-[0.84] text-slate-950 text-xl">
