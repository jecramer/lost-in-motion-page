...
// Import the background image to ensure it's properly processed by Vite
const backgroundImageUrl = new URL('/20250402_0948_Tranquil Garden Escape_remix_01jqtm426ses4b6n0vjbc17e6g.png', import.meta.url).href;
